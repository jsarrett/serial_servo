...
/** \file
 *
 *  Main source file for the SerialServo demo. This file contains the main tasks of
 ...
 */
USB_ClassInfo_CDC_Device_t SerialServo_CDC_Interface =
	{
		.Config =
			{
...
{
	CDC_Device_ProcessControlRequest(&SerialServo_CDC_Interface);
}
